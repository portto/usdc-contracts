# Teleport
### Lock USDC (Teleport to another blockchain)
```
...
flow transactions send ./transactions/teleport/lockTokensBSC.cdc \
  ...
  --signer usdc-admin-mainnet \
  --gas-limit 1000
```

### Teleport USDC to Solana
```
...
flow transactions send ./transactions/teleport/unlockTokens.cdc \
  ...
  --signer usdc-teleport-admin-testnet \
  --gas-limit 1000
```

### Unlock USDC from BSC
```
...
flow transactions sign ./build/unsigned.rlp \
  --signer usdc-teleport-admin-mainnet \
  --filter payload \
